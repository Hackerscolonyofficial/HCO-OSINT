...
def unlock():
    ...
    print(Fore.CYAN + "We will redirect you to our YouTube channel.")
    print(Fore.CYAN + "Subscribe and click on the bell 🔔 to unlock 🔓 the tool.\n")

    # Countdown
    for i in range(9, 0, -1):
        print(Fore.YELLOW + Style.BRIGHT + f"Redirecting in {i}...", end="\r")
        time.sleep(1)
    ...
    try:
        ...
        print(Fore.RED + "Unable to open browser automatically. Open manually: " + youtube_link)
...
def phone_lookup():
    ...
    try:
        ...
        print(Fore.YELLOW + "Country Code : " + Fore.WHITE + str(parsed.country_code))
        print(Fore.YELLOW + "Carrier      : " + Fore.WHITE + str(phonenumbers.carrier.name_for_number(parsed, "en") or "N/A"))
        print(Fore.YELLOW + "Line Type    : " + Fore.WHITE + str(phonenumbers.number_type(parsed)))
    except:
